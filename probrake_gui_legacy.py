...
class App(ctk.CTk):
    ...
    def _build_feel(self):
        ...
        for lbl, lo, hi, ini, cmd in [
                ("Dead Zone Min", 0, 30,  2, "tdzmin"),
                ("Dead Zone Max", 0, 30,  2, "tdzmax")]:
        ...
        for lbl, lo, hi, ini, cmd in [
                ("Dead Zone Min", 0, 30,  2, "cdzmin"),
                ("Dead Zone Max", 0, 30,  2, "cdzmax")]:
